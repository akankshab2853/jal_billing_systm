...
class Staff(models.Model):
    ...
    staff_address=models.TextField(null=True, blank=True)
    ...
    # Documents
    aadhar_card_number = models.CharField(max_length=12, unique=True, null=True, blank=True)
    pan_card_number = models.CharField(max_length=10, unique=True, null=True, blank=True)
